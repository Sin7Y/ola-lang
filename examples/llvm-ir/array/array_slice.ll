...
entry:
  ...
  %vector_length7 = load i64, ptr %3, align 4
  %vector_data8 = getelementptr i64, ptr %3, i64 1
  ...
  %index_access11 = getelementptr i64, ptr %vector_data9, i64 1
  store i64 101, ptr %index_access11, align 4
  %vector_length12 = load i64, ptr %4, align 4
  %vector_data13 = getelementptr i64, ptr %4, i64 1
  %5 = icmp eq i64 %vector_length7, %vector_length12
  %6 = zext i1 %5 to i64
  call void @builtin_assert(i64 %6)
  %7 = call i64 @memcmp_eq(ptr %vector_data8, ptr %vector_data13, i64 %vector_length7)
...
entry:
  switch i64 %0, label %missing_function [
    i64 3612930902, label %func_0_dispatch
  ]
