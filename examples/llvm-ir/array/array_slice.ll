...
entry:
  ...
  %vector_length13 = load i64, ptr %4, align 4
  %5 = icmp eq i64 %vector_length8, %vector_length13
  %6 = zext i1 %5 to i64
  call void @builtin_assert(i64 %6)
  %7 = call i64 @memcmp_eq(ptr %vector_data7, ptr %vector_data12, i64 %vector_length8)
