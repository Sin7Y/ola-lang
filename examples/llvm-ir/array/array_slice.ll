...
body:                                             ; preds = %cond
  ...
  %src_index_access = getelementptr i64, ptr %vector_data8, i64 %9
  %10 = load i64, ptr %src_index_access, align 4
  %11 = add i64 %index_value, 0
  %dest_index_access = getelementptr i64, ptr %vector_data7, i64 %11
  ...
  %12 = ptrtoint ptr %heap_to_ptr6 to i64
  %13 = add i64 %12, 1
  %vector_data9 = inttoptr i64 %13 to ptr
  %length10 = load i64, ptr %heap_to_ptr6, align 4
  %14 = call i64 @vector_new(i64 3)
  %heap_start11 = sub i64 %14, 3
  %heap_to_ptr12 = inttoptr i64 %heap_start11 to ptr
  store i64 2, ptr %heap_to_ptr12, align 4
  %15 = ptrtoint ptr %heap_to_ptr12 to i64
  %16 = add i64 %15, 1
  %vector_data13 = inttoptr i64 %16 to ptr
  ...
  %19 = icmp eq i64 %length10, %length17
...
cond18:                                           ; preds = %body19, %done
  ...
  %21 = icmp ult i64 %index21, %length10
  br i1 %21, label %body19, label %done20
