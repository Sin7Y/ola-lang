...
entry:
  ...
  %size = mul i64 %1, 1
  %2 = call i64 @vector_new(i64 %size)
  %heap_ptr = sub i64 %2, %size
  %int_to_ptr = inttoptr i64 %heap_ptr to ptr
  store i64 0, ptr %index_alloca, align 4
  br label %cond
...
body:                                             ; preds = %cond
  ...
  %3 = call ptr @vector_new_init(i64 %size, ptr %int_to_ptr)
  ret ptr %3
}
...
buffer_read:                                      ; preds = %inbounds
  ...
  %vector_len = getelementptr inbounds { i64, ptr }, ptr %6, i32 0, i32 0
  %length = load i64, ptr %vector_len, align 4
...
loop_body:                                        ; preds = %loop_body, %buffer_read
  ...
  %element = getelementptr { i64, ptr }, ptr %6, i64 %index
