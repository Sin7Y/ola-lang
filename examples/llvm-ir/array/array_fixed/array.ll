...
buffer_read:                                      ; preds = %inbounds
  %8 = call ptr @array_call(ptr %array_literal)
  %elemptr01 = getelementptr [3 x i64], ptr %8, i64 0, i64 0
  %9 = load i64, ptr %elemptr01, align 4
  call void @tape_store(i64 0, i64 %9)
  %elemptr12 = getelementptr [3 x i64], ptr %8, i64 0, i64 1
  %10 = load i64, ptr %elemptr12, align 4
  call void @tape_store(i64 1, i64 %10)
  %elemptr23 = getelementptr [3 x i64], ptr %8, i64 0, i64 2
  %11 = load i64, ptr %elemptr23, align 4
  call void @tape_store(i64 2, i64 %11)
  ret void
}
