...
entry:
  ...
  %index_access1 = getelementptr [3 x i64], ptr %0, i64 0, i64 1
  %index_access2 = getelementptr [3 x i64], ptr %0, i64 0, i64 1
  %1 = load i64, ptr %index_access2, align 4
  %2 = add i64 %1, 1
  call void @builtin_range_check(i64 %2)
  store i64 %2, ptr %index_access1, align 4
  %index_access3 = getelementptr [3 x i64], ptr %0, i64 0, i64 2
  %index_access4 = getelementptr [3 x i64], ptr %0, i64 0, i64 2
  %3 = load i64, ptr %index_access4, align 4
  %4 = sub i64 %3, 1
  call void @builtin_range_check(i64 %4)
  store i64 %4, ptr %index_access3, align 4
  %index_access5 = getelementptr [3 x i64], ptr %0, i64 0, i64 1
