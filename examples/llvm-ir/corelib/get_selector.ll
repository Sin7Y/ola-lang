; ModuleID = 'GetSelector'
source_filename = "get_selector"
...
define i64 @get_selector_test() {
entry:
  %selector = alloca i64, align 8
  store i64 2653574029, ptr %selector, align 4
  %0 = load i64, ptr %selector, align 4
  ret i64 %0
}
...
entry:
  switch i64 %0, label %missing_function [
    i64 1570732554, label %func_0_dispatch
  ]
