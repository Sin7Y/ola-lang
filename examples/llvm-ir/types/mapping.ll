...
entry:
  ...
  call void @memcpy(ptr %heap_to_ptr15, ptr %30, i64 4)
  %next_dest_offset18 = add i64 %heap_start16, 4
  %31 = inttoptr i64 %next_dest_offset18 to ptr
  call void @memcpy(ptr %24, ptr %31, i64 4)
  ...
  call void @memcpy(ptr %heap_to_ptr20, ptr %39, i64 4)
  %next_dest_offset25 = add i64 %heap_start23, 4
  %40 = inttoptr i64 %next_dest_offset25 to ptr
  call void @memcpy(ptr %heap_to_ptr22, ptr %40, i64 4)
  ...
  %slot_value = load i64, ptr %heap_to_ptr27, align 4
  %slot_offset = add i64 %slot_value, 1
  store i64 %slot_offset, ptr %heap_to_ptr27, align 4
