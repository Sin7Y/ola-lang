; ModuleID = 'dynamicarray'
source_filename = "dynamatic_array"
...
body2:                                            ; preds = %cond1
  ...
  %10 = call i64 @u32_power(i64 2, i64 %9)
  %11 = mul i64 1, %10
  call void @builtin_range_check(i64 %11)
  store i64 %11, ptr %index_access4, align 4
  br label %next
...
next:                                             ; preds = %body2
  ...
  %vector_length5 = load i64, ptr %2, align 4
  %14 = load i64, ptr %size, align 4
  %15 = icmp eq i64 %vector_length5, %14
...
entry:
  switch i64 %0, label %missing_function [
    i64 825771700, label %func_0_dispatch
  ]
