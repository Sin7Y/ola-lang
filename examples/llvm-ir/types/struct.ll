...
entry:
  ...
  %struct_member = getelementptr inbounds { i64, i64 }, ptr %1, i32 0, i32 1
  %2 = load i64, ptr %struct_member, align 4
  %3 = icmp eq i64 %2, 2
  br i1 %3, label %then, label %endif

then:                                             ; preds = %entry
  %struct_member1 = getelementptr inbounds { i64, i64 }, ptr %1, i32 0, i32 0
  %4 = load i64, ptr %struct_member1, align 4
  %5 = icmp eq i64 %4, 12
  br i1 %5, label %then2, label %endif3

endif:                                            ; preds = %endif12, %entry
  %6 = load i64, ptr %score, align 4
  ret i64 %6

then2:                                            ; preds = %then
  store i64 14, ptr %score, align 4
  br label %endif3

endif3:                                           ; preds = %then2, %then
  %struct_member4 = getelementptr inbounds { i64, i64 }, ptr %1, i32 0, i32 0
  %7 = load i64, ptr %struct_member4, align 4
  %8 = icmp eq i64 %7, 11
  br i1 %8, label %then5, label %endif6

then5:                                            ; preds = %endif3
  store i64 13, ptr %score, align 4
  br label %endif6

endif6:                                           ; preds = %then5, %endif3
  %struct_member7 = getelementptr inbounds { i64, i64 }, ptr %1, i32 0, i32 0
  %9 = load i64, ptr %struct_member7, align 4
  %10 = icmp eq i64 %9, 10
  br i1 %10, label %then8, label %endif9

then8:                                            ; preds = %endif6
  store i64 12, ptr %score, align 4
  br label %endif9

endif9:                                           ; preds = %then8, %endif6
  %struct_member10 = getelementptr inbounds { i64, i64 }, ptr %1, i32 0, i32 0
  %11 = load i64, ptr %struct_member10, align 4
  %12 = icmp eq i64 %11, 9
  br i1 %12, label %then11, label %endif12

then11:                                           ; preds = %endif9
  store i64 11, ptr %score, align 4
  br label %endif12

endif12:                                          ; preds = %then11, %endif9
  br label %endif
}
...
entry:
  switch i64 %0, label %missing_function [
    i64 933346030, label %func_0_dispatch
  ]
...
func_0_dispatch:                                  ; preds = %entry
  ...
  %4 = load i64, ptr %decode_struct_field, align 4
  %decode_struct_field1 = getelementptr ptr, ptr %3, i64 1
  %5 = load i64, ptr %decode_struct_field1, align 4
  %6 = call ptr @heap_malloc(i64 2)
  %struct_member = getelementptr inbounds { i64, i64 }, ptr %6, i32 0, i32 0
  store i64 %4, ptr %struct_member, align 4
  %struct_member2 = getelementptr inbounds { i64, i64 }, ptr %6, i32 0, i32 1
  store i64 %5, ptr %struct_member2, align 4
  %7 = call i64 @score_card(ptr %6)
