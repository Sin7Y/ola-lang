...
entry:
  ...
  call void @mempcy(ptr %vector_data, ptr %heap_to_ptr, i64 %length)
  %9 = ptrtoint ptr %vector_data3 to i64
  %10 = add i64 %9, %length
  %11 = inttoptr i64 %10 to ptr
  call void @mempcy(ptr %vector_data2, ptr %11, i64 %length1)
  ret ptr %11
}
...
func_0_dispatch:                                  ; preds = %entry
  ...
  call void @mempcy(ptr %vector_data, ptr %7, i64 %length1)
  %10 = add i64 %length1, 1
  %encode_value_ptr2 = getelementptr i64, ptr %heap_to_ptr, i64 %10
