...
entry:
  ...
  store i64 109, ptr %index_access5, align 4
...
entry:
  ...
  switch i64 %0, label %missing_function [
    i64 3510571750, label %func_0_dispatch
  ]
...
func_0_dispatch:                                  ; preds = %entry
  ...
  call void @memcpy(ptr %vector_data, ptr %5, i64 %6)
  %7 = add i64 %6, 0
  %encode_value_ptr = getelementptr i64, ptr %5, i64 %7
  store i64 %4, ptr %encode_value_ptr, align 4
  call void @set_tape_data(ptr %5, i64 %heap_size)
  ret void
}
