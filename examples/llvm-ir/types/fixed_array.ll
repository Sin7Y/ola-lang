...
entry:
  ...
  %ayes = alloca i64, align 8
  %i = alloca i64, align 8
  %votes = alloca ptr, align 8
  store ptr %0, ptr %votes, align 8
  %2 = load ptr, ptr %votes, align 8
  store i64 0, ptr %i, align 4
  store i64 0, ptr %ayes, align 4
  store i64 0, ptr %i, align 4
  br label %cond
...
body:                                             ; preds = %cond
  ...
  %6 = sub i64 10, %5
  call void @builtin_range_check(i64 %6)
  %index_access = getelementptr [11 x i64], ptr %2, i64 0, i64 %5
...
next:                                             ; preds = %endif
  ...
  %11 = load i64, ptr %ayes, align 4
  call void @u32_div_mod(i64 11, i64 2, ptr %1, ptr null)
...
then:                                             ; preds = %body
  %15 = load i64, ptr %ayes, align 4
  %16 = add i64 %15, 1
  call void @builtin_range_check(i64 %16)
  store i64 %16, ptr %ayes, align 4
  br label %endif
...
define i64 @primenumber(i64 %0) {
entry:
  %n = alloca i64, align 8
  store i64 %0, ptr %n, align 4
  %1 = call ptr @heap_malloc(i64 10)
  %elemptr0 = getelementptr [10 x i64], ptr %1, i64 0, i64 0
  store i64 2, ptr %elemptr0, align 4
  %elemptr1 = getelementptr [10 x i64], ptr %1, i64 0, i64 1
  store i64 3, ptr %elemptr1, align 4
  %elemptr2 = getelementptr [10 x i64], ptr %1, i64 0, i64 2
  store i64 5, ptr %elemptr2, align 4
  %elemptr3 = getelementptr [10 x i64], ptr %1, i64 0, i64 3
  store i64 7, ptr %elemptr3, align 4
  %elemptr4 = getelementptr [10 x i64], ptr %1, i64 0, i64 4
  store i64 11, ptr %elemptr4, align 4
  %elemptr5 = getelementptr [10 x i64], ptr %1, i64 0, i64 5
  store i64 13, ptr %elemptr5, align 4
  %elemptr6 = getelementptr [10 x i64], ptr %1, i64 0, i64 6
  store i64 17, ptr %elemptr6, align 4
  %elemptr7 = getelementptr [10 x i64], ptr %1, i64 0, i64 7
  store i64 19, ptr %elemptr7, align 4
  %elemptr8 = getelementptr [10 x i64], ptr %1, i64 0, i64 8
  store i64 23, ptr %elemptr8, align 4
  %elemptr9 = getelementptr [10 x i64], ptr %1, i64 0, i64 9
  store i64 29, ptr %elemptr9, align 4
...
entry:
  switch i64 %0, label %missing_function [
    i64 1609477595, label %func_0_dispatch
    i64 2688594262, label %func_1_dispatch
  ]
