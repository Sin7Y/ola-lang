; ModuleID = 'enum_example'
source_filename = "enum"
...
define i64 @is_weekend(i64 %0) {
entry:
  %day = alloca i64, align 8
  store i64 %0, ptr %day, align 4
  %1 = load i64, ptr %day, align 4
  %2 = icmp eq i64 %1, 5
  %3 = load i64, ptr %day, align 4
  %4 = icmp eq i64 %3, 6
  %5 = zext i1 %2 to i64
  %6 = zext i1 %4 to i64
  %7 = or i64 %5, %6
...
entry:
  switch i64 %0, label %missing_function [
    i64 2925791536, label %func_0_dispatch
  ]
