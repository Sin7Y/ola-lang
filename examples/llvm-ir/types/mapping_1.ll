...
>>>>>>> c951d67 ((bugfix) fixed storage slot and value arrangement.)
  ...
  call void @memcpy(ptr %2, ptr %34, i64 4)
  ...
  call void @set_storage(ptr %46, ptr %47)
  ...
  %61 = load i64, ptr %_nonce, align 4
  %62 = call ptr @heap_malloc(i64 4)
  %63 = getelementptr i64, ptr %62, i64 0
  store i64 0, ptr %63, align 4
  %64 = getelementptr i64, ptr %62, i64 1
  store i64 0, ptr %64, align 4
  %65 = getelementptr i64, ptr %62, i64 2
  store i64 0, ptr %65, align 4
  %66 = getelementptr i64, ptr %62, i64 3
  store i64 %61, ptr %66, align 4
  %67 = call ptr @heap_malloc(i64 8)
  call void @memcpy(ptr %60, ptr %67, i64 4)
  %68 = getelementptr i64, ptr %67, i64 4
  call void @memcpy(ptr %62, ptr %68, i64 4)
  %69 = getelementptr i64, ptr %68, i64 4
  %70 = call ptr @heap_malloc(i64 4)
  call void @poseidon_hash(ptr %67, ptr %70, i64 8)
  %71 = call ptr @heap_malloc(i64 4)
  call void @get_storage(ptr %70, ptr %71)
  %72 = getelementptr i64, ptr %71, i64 3
  %storage_value1 = load i64, ptr %72, align 4
  %73 = getelementptr i64, ptr %70, i64 3
  %74 = load i64, ptr %73, align 4
  %slot_offset2 = add i64 %74, 1
  store i64 %slot_offset2, ptr %73, align 4
