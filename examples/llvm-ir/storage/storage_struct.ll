...
entry:
  ...
  %2 = call ptr @heap_malloc(i64 2)
  %struct_member = getelementptr inbounds { i64, i64 }, ptr %2, i32 0, i32 0
  %3 = load i64, ptr %_id, align 4
  store i64 %3, ptr %struct_member, align 4
  %struct_member1 = getelementptr inbounds { i64, i64 }, ptr %2, i32 0, i32 1
  %4 = load i64, ptr %_value, align 4
  store i64 %4, ptr %struct_member1, align 4
  %id = getelementptr inbounds { i64, i64 }, ptr %2, i32 0, i32 0
  ...
  call void @set_storage(ptr %6, ptr %10)
  %value = getelementptr inbounds { i64, i64 }, ptr %2, i32 0, i32 1
...
entry:
  ...
  %storage_value = load i64, ptr %0, align 4
...
entry:
  ...
  switch i64 %0, label %missing_function [
    i64 489261859, label %func_0_dispatch
    i64 1002823216, label %func_1_dispatch
  ]
