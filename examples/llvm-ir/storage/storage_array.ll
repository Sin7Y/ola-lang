...
body:                                             ; preds = %body, %entry
  ...
  store i64 %3, ptr %heap_to_ptr4, align 4
  ...
  call void @set_storage(ptr %heap_to_ptr2, ptr %heap_to_ptr4)
