; ModuleID = 'DeleteExample'
source_filename = "delete"
...
body:                                             ; preds = %cond
  ...
  %storage_zero_ptr = getelementptr i64, ptr %15, i64 0
  store i64 0, ptr %storage_zero_ptr, align 4
  %storage_zero_ptr1 = getelementptr i64, ptr %15, i64 1
  store i64 0, ptr %storage_zero_ptr1, align 4
  %storage_zero_ptr2 = getelementptr i64, ptr %15, i64 2
  store i64 0, ptr %storage_zero_ptr2, align 4
  %storage_zero_ptr3 = getelementptr i64, ptr %15, i64 3
  ...
  %storage_zero_ptr4 = getelementptr i64, ptr %23, i64 0
  store i64 0, ptr %storage_zero_ptr4, align 4
  %storage_zero_ptr5 = getelementptr i64, ptr %23, i64 1
  store i64 0, ptr %storage_zero_ptr5, align 4
  %storage_zero_ptr6 = getelementptr i64, ptr %23, i64 2
  store i64 0, ptr %storage_zero_ptr6, align 4
  %storage_zero_ptr7 = getelementptr i64, ptr %23, i64 3
  store i64 0, ptr %storage_zero_ptr7, align 4
  call void @set_storage(ptr %18, ptr %23)
  %24 = load i64, ptr %y, align 4
  ...
  call void @get_storage(ptr %26, ptr %25)
  %31 = getelementptr i64, ptr %25, i64 3
  %storage_value = load i64, ptr %31, align 4
  %slot_offset = add i64 %24, 1
  %32 = icmp eq i64 %storage_value, 0
  %33 = zext i1 %32 to i64
  call void @builtin_assert(i64 %33)
  ret void
}

define void @delete_f_memory() {
entry:
  %0 = alloca ptr, align 8
  ...
  %length = getelementptr i64, ptr %2, i64 3
  %8 = load i64, ptr %length, align 4
  %9 = call ptr @vector_new(i64 %8)
  ...
  %15 = call ptr @heap_malloc(i64 4)
  call void @poseidon_hash(ptr %10, ptr %15, i64 4)
  store i64 0, ptr %index_alloca, align 4
...
cond:                                             ; preds = %body, %entry
  %index_value = load i64, ptr %index_alloca, align 4
  %loop_cond = icmp ult i64 %index_value, %8
  br i1 %loop_cond, label %body, label %done
...
body:                                             ; preds = %cond
  ...
  %length1 = getelementptr i64, ptr %21, i64 3
  %27 = load i64, ptr %length1, align 4
  ...
  call void @poseidon_hash(ptr %28, ptr %33, i64 4)
...
cond2:                                            ; preds = %body3, %done
  ...
  %loop_cond7 = icmp ult i64 %index_value6, %27
  br i1 %loop_cond7, label %body3, label %done4

body3:                                            ; preds = %cond2
  %34 = load ptr, ptr %0, align 8
  %35 = call ptr @heap_malloc(i64 4)
  %storage_zero_ptr = getelementptr i64, ptr %35, i64 0
  store i64 0, ptr %storage_zero_ptr, align 4
  %storage_zero_ptr8 = getelementptr i64, ptr %35, i64 1
  store i64 0, ptr %storage_zero_ptr8, align 4
  %storage_zero_ptr9 = getelementptr i64, ptr %35, i64 2
  store i64 0, ptr %storage_zero_ptr9, align 4
  %storage_zero_ptr10 = getelementptr i64, ptr %35, i64 3
  store i64 0, ptr %storage_zero_ptr10, align 4
  call void @set_storage(ptr %34, ptr %35)
  %36 = call ptr @heap_malloc(i64 4)
  call void @memcpy(ptr %34, ptr %36, i64 4)
  %last_elem_ptr11 = getelementptr i64, ptr %36, i64 3
  %37 = load i64, ptr %last_elem_ptr11, align 4
  %last_elem12 = add i64 %37, 1
  store i64 %last_elem12, ptr %last_elem_ptr11, align 4
  store ptr %36, ptr %0, align 8
  %next_index13 = add i64 %index_value6, 1
  store i64 %next_index13, ptr %index_alloca5, align 4
  br label %cond2
...
entry:
  switch i64 %0, label %missing_function [
    i64 3673556789, label %func_0_dispatch
    i64 2703371104, label %func_1_dispatch
  ]
