; ModuleID = 'ReturnExample'
source_filename = "return"
...
define ptr @return_storage_array() {
entry:
...
define ptr @return_storage_string() {
entry:
  %0 = alloca ptr, align 8
  %index_alloca = alloca i64, align 8
  %1 = call ptr @heap_malloc(i64 4)
...
define i64 @return_storage_struct() {
entry:
...
entry:
  switch i64 %0, label %missing_function [
    i64 3434543471, label %func_0_dispatch
    i64 2138885106, label %func_1_dispatch
    i64 963245269, label %func_2_dispatch
  ]
...
func_0_dispatch:                                  ; preds = %entry
  %3 = call ptr @return_storage_array()
  ...
  %7 = mul i64 %vector_length1, 1
  %8 = add i64 %7, 1
  call void @memcpy(ptr %3, ptr %6, i64 %8)
...
func_1_dispatch:                                  ; preds = %entry
  %10 = call ptr @return_storage_string()
...
func_2_dispatch:                                  ; preds = %entry
  %15 = call i64 @return_storage_struct()
