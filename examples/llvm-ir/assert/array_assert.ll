...
body:                                             ; preds = %cond
  ...
  %1 = icmp eq i64 %vector_length, 3
  %2 = zext i1 %1 to i64
  call void @builtin_assert(i64 %2)
  %vector_length1 = load i64, ptr %0, align 4
  %3 = sub i64 %vector_length1, 1
  %4 = sub i64 %3, 0
  call void @builtin_range_check(i64 %4)
  %vector_data2 = getelementptr i64, ptr %0, i64 1
  %index_access3 = getelementptr i64, ptr %vector_data2, i64 0
  store i64 1, ptr %index_access3, align 4
  %vector_length4 = load i64, ptr %0, align 4
  %5 = sub i64 %vector_length4, 1
  %6 = sub i64 %5, 0
  call void @builtin_range_check(i64 %6)
  %vector_data5 = getelementptr i64, ptr %0, i64 1
  %index_access6 = getelementptr i64, ptr %vector_data5, i64 0
  %7 = load i64, ptr %index_access6, align 4
  %8 = icmp eq i64 %7, 1
  %9 = zext i1 %8 to i64
