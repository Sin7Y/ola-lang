...
Ola is compiled into ola ir, which is then optimized and compiled into ola opcode, which is executed by the Ola VM.

Ola is influenced by solidity and rust and very easy for developers familiar with solidity and rust to get started, It is statically typed, supports complex user-defined types among other features.
