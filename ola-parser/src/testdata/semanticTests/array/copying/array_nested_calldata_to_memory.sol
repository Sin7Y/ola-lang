...
contract c {
    fn test1(u256[][] calldata c) external -> (u256, u256) {
        u256[][] memory a1 = c;
        assert(a1[0][0] == c[0][0]);
        assert(a1[0][1] == c[0][1]);
    ...
    fn test2(u256[][2] calldata c) external -> (u256, u256) {
        u256[][2] memory a2 = c;
        assert(a2[0][0] == c[0][0]);
        assert(a2[0][1] == c[0][1]);
    ...
    fn test3(u256[2][] calldata c) external -> (u256, u256) {
        u256[2][] memory a3 = c;
        assert(a3[0][0] == c[0][0]);
        assert(a3[0][1] == c[0][1]);
    ...
    fn test4(u256[2][2] calldata c) external -> (u256) {
        u256[2][2] memory a4 = c;
        assert(a4[0][0] == c[0][0]);
        assert(a4[0][1] == c[0][1]);
