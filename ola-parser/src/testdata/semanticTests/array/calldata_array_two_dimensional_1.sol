pragma abicoder               v2;
contract C {
    fn test(u256[][] calldata a) external -> (u256) {
        return a.length;
    }
    fn test(u256[][] calldata a, u256 i) external -> (u256) {
        return a[i].length;
    }
    fn test(u256[][] calldata a, u256 i, u256 j) external -> (u256) {
        return a[i][j];
    }
    fn reenc(u256[][] calldata a, u256 i, u256 j) external -> (u256) {
