contract C {
    fn e(bytes memory b) public pure returns (bytes memory) {
        return b;
    }
    fn f() public pure returns (string memory, string memory) {
        return ("any", "any");
    }
    fn g() public pure returns (string memory, uint, string memory) {
        return ("any", 42, "any");
    }
    fn h() public pure returns (string memory) {
        return "any";
    }
}
// ====
