contract test {
    ...
    fn set_internal(mapping(uint8 => uint8)[2] storage m, uint8 key, uint8 value1, uint8 value2) internal -> (uint8, uint8) {
    ...
    fn set(uint8 key, uint8 value_a1, uint8 value_a2, uint8 value_b1, uint8 value_b2)  -> (uint8 old_a1, uint8 old_a2, uint8 old_b1, uint8 old_b2) {
        (old_a1, old_a2) = set_internal(a, key, value_a1, value_a2);
        (old_b1, old_b2) = set_internal(b, key, value_b1, value_b2);
    }
    fn get(uint8 key)  -> (uint8, uint8, uint8, uint8) {
