...
contract test {
    ...
    fn div(uint256 x, uint256 y) external pure returns (uint256 ret) {
        ret = x.div(y);
    }
    fn exp(uint256 x) external pure returns (uint256 ret) {
        ret = x.exp();
    }
    fn exp2(uint256 x) external pure returns (uint256 ret) {
        ret = x.exp2();
    }
    fn gm(uint256 x, uint256 y) external pure returns (uint256 ret) {
        ret = x.gm(y);
    }
    fn log10(uint256 x) external pure returns (uint256 ret) {
        ret = x.log10();
    }
    fn log2(uint256 x) external pure returns (uint256 ret) {
        ret = x.log2();
    }
    fn mul(uint256 x, uint256 y) external pure returns (uint256 ret) {
        ret = x.mul(y);
    }
    fn pow(uint256 x, uint256 y) external pure returns (uint256 ret) {
        ret = x.pow(y);
    }
    fn sqrt(uint256 x) external pure returns (uint256 ret) {
        ret = x.sqrt();
    }
    fn benchmark(uint256 x) external pure returns (uint256 ret, uint256 z1, uint256 z2) {
