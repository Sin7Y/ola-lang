...
contract test {
    ...
    fn div(int256 x, int256 y) external pure returns (int256 ret) {
        ret = x.div(y);
    }
    fn exp(int256 x) external pure returns (int256 ret) {
        ret = x.exp();
    }
    fn exp2(int256 x) external pure returns (int256 ret) {
        ret = x.exp2();
    }
    fn gm(int256 x, int256 y) external pure returns (int256 ret) {
        ret = x.gm(y);
    }
    fn log10(int256 x) external pure returns (int256 ret) {
        ret = x.log10();
    }
    fn log2(int256 x) external pure returns (int256 ret) {
        ret = x.log2();
    }
    fn mul(int256 x, int256 y) external pure returns (int256 ret) {
        ret = x.mul(y);
    }
    fn pow(int256 x, uint256 y) external pure returns (int256 ret) {
        ret = x.pow(y);
    }
    fn sqrt(int256 x) external pure returns (int256 ret) {
        ret = x.sqrt();
    }
    fn benchmark(int256 x) external pure returns (int256 ret, int256 z1, int256 z2) {
