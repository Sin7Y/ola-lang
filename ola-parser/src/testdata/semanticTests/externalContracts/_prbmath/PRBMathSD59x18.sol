...
library PRBMathSD59x18 {
    ...
    fn abs(int256 x) internal pure returns (int256 result) {
        unchecked {
    ...
    fn avg(int256 x, int256 y) internal pure returns (int256 result) {
    ...
    fn ceil(int256 x) internal pure returns (int256 result) {
    ...
    fn div(int256 x, int256 y) internal pure returns (int256 result) {
    ...
    fn e() internal pure returns (int256 result) {
    ...
    fn exp(int256 x) internal pure returns (int256 result) {
    ...
    /// @param x The exponent as a signed 59.18-decimal fixed-point number.
    /// @return result The result as a signed 59.18-decimal fixed-point number.
    fn exp2(int256 x) internal pure returns (int256 result) {
    ...
    fn floor(int256 x) internal pure returns (int256 result) {
    ...
    fn frac(int256 x) internal pure returns (int256 result) {
    ...
    /// @param y The second operand as a signed 59.18-decimal fixed-point number.
    /// @return result The result as a signed 59.18-decimal fixed-point number.
    fn gm(int256 x, int256 y) internal pure returns (int256 result) {
        if (x == 0) {
            return 0;
        }
    ...
    fn inv(int256 x) internal pure returns (int256 result) {
        unchecked {
            // 1e36 is SCALE * SCALE.
            result = 1e36 / x;
        }
    ...
    fn ln(int256 x) internal pure returns (int256 result) {
    ...
    fn log10(int256 x) internal pure returns (int256 result) {
        require(x > 0);
    ...
    fn log2(int256 x) internal pure returns (int256 result) {
        require(x > 0);
        unchecked {
    ...
    /// @return result The result as a signed 59.18-decimal fixed-point number.
    fn mul(int256 x, int256 y) internal pure returns (int256 result) {
        require(x > MIN_SD59x18);
    ...
    fn pi() internal pure returns (int256 result) {
    ...
    /// @return result The result as a signed 59.18-decimal fixed-point number.
    fn pow(int256 x, uint256 y) internal pure returns (int256 result) {
    ...
    fn scale() internal pure returns (int256 result) {
        result = SCALE;
    }
    ...
    fn sqrt(int256 x) internal pure returns (int256 result) {
        require(x >= 0);
