abstract contract C {
    ...
    fn one() public pure returns (uint) {}
    fn two() public pure returns (uint, uint) {}
    fn three() public pure returns (uint, uint, uint) {}
    fn four() public pure returns (uint, uint, uint, uint) {}
    fn five() public pure returns (uint, uint, uint, uint, uint) {}
}
// ----
