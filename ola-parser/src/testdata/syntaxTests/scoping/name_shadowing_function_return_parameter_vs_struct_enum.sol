contract C {
    ...
    fn f() external returns (StructType memory StructType) {}
    fn g() external returns (EnumType EnumType) {}
    fn h() external returns (EnumType StructType, StructType memory EnumType) {}

    fn z(uint EnumType) external returns (EnumType e) {}
}
// ----
