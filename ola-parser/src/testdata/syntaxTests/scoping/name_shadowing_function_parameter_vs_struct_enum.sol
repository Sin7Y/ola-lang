contract C {
    ...
    fn f(StructType memory StructType) external {}
    fn g(EnumType EnumType) external {}
    fn h(EnumType StructType, StructType memory EnumType) external {}

    fn z(EnumType e) external returns (uint EnumType) {}
}
// ----
