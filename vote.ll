...
done12:                                           ; preds = %cond10
  ...
  %46 = extractvalue [4 x i64] %43, 3
  %47 = add i64 %46, 1
  %48 = insertvalue [4 x i64] %43, i64 %47, 3
  %new_length = add i64 %5, 1
  %49 = insertvalue [4 x i64] [i64 0, i64 0, i64 0, i64 undef], i64 %new_length, 3
  call void @set_storage([4 x i64] [i64 0, i64 0, i64 0, i64 3], [4 x i64] %49)
  br label %next
}
...
entry:
  ...
  %40 = call [4 x i64] @poseidon_hash([8 x i64] [i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 3])
...
then:                                             ; preds = %body
  ...
  %24 = call [4 x i64] @poseidon_hash([8 x i64] [i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 3])
...
body:                                             ; preds = %cond
  ...
  %30 = extractvalue [4 x i64] %9, 3
  %31 = add i64 %30, 1
  %32 = insertvalue [4 x i64] %9, i64 %31, 3
  ret ptr %12
}
