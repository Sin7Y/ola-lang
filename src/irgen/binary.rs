...
impl<'a> Binary<'a> {
    ...
    //                 &[
    //                     arg.into(),
    //                     self.context.i64_type().const_int(3, false).into(),
    //                 ],
    //                 "",
    //             );
    //         }
    //         Type::Address => {
    //             let address_start = self.builder.build_ptr_to_int(
    ...
    //         }
    //         Type::Hash => {
    //             let hash_start = self.builder.build_ptr_to_int(
    //                 arg.into_pointer_value(),
    //                 self.context.i64_type(),
    //                 "hash_start",
    //             );
    ...
    //         }
    //         Type::String => {
    //             let string_start = self.builder.build_ptr_to_int(
    //                 arg.into_pointer_value(),
    //                 self.context.i64_type(),
    //                 "string_start",
    //             );
    ...
    //         }
    //         Type::Array(_, dims) => {
    //             let array_start = self.builder.build_ptr_to_int(
    //                 arg.into_pointer_value(),
    //                 self.context.i64_type(),
    //                 "array_start",
    //             );
    ...
    //         }
    //         Type::Struct(_) => {
    //             let struct_start = self.builder.build_ptr_to_int(
    //                 arg.into_pointer_value(),
    //                 self.context.i64_type(),
    //                 "struct_start",
    //             );
