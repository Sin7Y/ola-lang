...
use crate::ir::selector::{is_global_id, next_func_id, next_global_value_id};
use crate::ir::selector::{BasicBlockId, FunctionId, ValueId};
...
/// Hold global values and functions.
#[derive(Default)]
pub struct Program {
