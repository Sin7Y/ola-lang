...
pub(crate) fn process_builtin(
    ...
    match builtin_ty {
        ...
        YulBuiltInFunction::IsZero => {
            ...
            let right = Expression::NumberLiteral(program::Loc::Codegen, left.ty(), BigInt::from(0));
...
fn branch_if_zero(
    ...
    cfg.add_yul(
        ...
        Instr::Set {
            ...
            res: temp,
            expr: Expression::NumberLiteral(program::Loc::Codegen, Type::Uint(256), BigInt::from(0)),
        },
    );
    ...
    Expression::Variable(program::Loc::Codegen, Type::Uint(256), temp)
}
...
fn byte_builtin(
    ...
    cfg.add_yul(
        ...
        Instr::Set {
            loc: program::Loc::Codegen,
            res: temp,
            expr: Expression::NumberLiteral(program::Loc::Codegen, Type::Uint(256), BigInt::zero()),
        },
    );
    cfg.add_yul(vartab, Instr::Branch { block: endif });
