...
impl ControlFlowGraph {
    pub fn new(name: String, function_no: ASTFunction) -> Self {
        let mut cfg = ControlFlowGraph {
            ...
            nonpayable: false,
            public: false,
            ty: program::FunctionTy::Function,
            selector: Vec::new(),
            current: 0,
...
fn is_there_virtual_function(
    ...
    if func.ty == program::FunctionTy::Receive {
    ...
    if func.ty == program::FunctionTy::Modifier || !func.has_body {
        return true;
    }
...
pub fn generate_cfg(
    ...
    if let Some(func_no) = function_no {
        ...
        if !func.modifiers.is_empty() {
            ...
            assert_eq!(func.ty, program::FunctionTy::Function);
...
fn function_cfg(
    ...
    if func.ty == program::FunctionTy::Constructor && func.contract_no == Some(contract_no) {
